...
source_dir = '/mnt/nas01/LSR/DATA/2p_bench/mini2p/ca1/'  # 源文件夹
...
imagePairs = np.zeros((2 * N_pair_per_file, stack_length, 512, 512), dtype=np.float32)  # 假设大小为 256x256

ind = 0

file_name_list = []
file_name_list.append(source_dir + '97288_20210315_00002.tif')
...
# 定义文件名
filename = f'/mnt/nas02/LSR/DATA/NAOMi_dataset/N_{imagePairs.shape[0]}_mini2p_ca1_stack_24.h5'
